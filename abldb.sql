...
-- テーブル abldb.following_ablation: ~1 rows (約) のデータをダンプしています
...
-- テーブル abldb.internal_medicine: ~3 rows (約) のデータをダンプしています
...
-- テーブル abldb.logins: ~8 rows (約) のデータをダンプしています
DELETE FROM `logins`;
...
INSERT INTO `logins` (`login_id`, `user_id`, `token`, `is_logged_out`, `logged_in_at`) VALUES
	...
	(22, 'test', 'jmODJncnVSCTSgVA6w6T50Wj3FTWASnhx32QVjXwxnjGVCN1ZYZUxzNXS0mYXlxW', b'0', '2021-05-21 11:53:12'),
	(23, 'test', '465pvPsh2SjC1OVFXgHOlDTW1hN8PDBasLHT6U4WW7h4Z7s8jNa0ZqZUeEovICzz', b'0', '2021-05-21 13:27:12');
...
-- テーブル abldb.patients: ~3 rows (約) のデータをダンプしています
...
INSERT INTO `patients` (`patient_serial_number`, `registered_by`, `hospital_id`, `patient_number`, `ucg_id`, `name`, `name_kana`, `sex`, `weight`, `birthday`, `height`, `af_kind`, `rfca_cb`, `ehra_score`, `has_symptom`, `frality_scale`, `rhythm`, `heart_rate`, `pr_gap`, `qrs`, `sss`, `av_block`, `pm`, `icd`, `crtp`, `crtd`, `af_onset_on`, `af_immobilized_on`, `maze`, `open_heart`, `open_heart_detail`, `ht`, `dm`, `dyslip`, `hu`, `smoking_history`, `dialysys`, `thrombosis`, `ischemic_stroke`, `tia`, `hemorrhagic_stroke`, `isth_bleeding`, `problematic_bleeding`, `chf_nyha`, `blood_vessel_disease`, `sas`, `omi`, `ihd`, `hcm`, `dcm`, `other_cardiomiopathy`, `mr`, `ms`, `valvular_disease`, `hyperthyroidism`, `hypothyreosis`, `asd`, `other_congenital`, `ctd`, `malignancy`, `hba1c`, `cre`, `egfr`, `ccr`, `nt_pro_bnp`, `bnp`, `aptt`, `pt_inr`, `d_dimer`, `hb`, `hmt`, `tsh`, `ft4`, `ast`, `alt`, `tbil`) VALUES
	(1, 'test', 1, 2, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, b'0', b'0', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.40000, 0.06000, 0.70000, 1.20000, 1.40000, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
...
-- テーブル abldb.ucg: ~2 rows (約) のデータをダンプしています
DELETE FROM `ucg`;
...
-- テーブル abldb.users: ~1 rows (約) のデータをダンプしています
DELETE FROM `users`;
